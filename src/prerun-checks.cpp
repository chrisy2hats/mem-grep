...
[[nodiscard]] bool PreRunCheck(void) {
    ...
    if (sizeof(void *) != sizeof(size_t)) {
        cout << "Program running on unusual architecture where a pointer isn't as large as a size_t.Don't be surprised if this doesn't work...\n";
    }
    ...
    cout << "ERROR: Yama ptrace to restricted and program not run as root. mem-grep cannot run as it can't access other processes memory. Exiting now...\n";
